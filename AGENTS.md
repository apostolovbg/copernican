...
# DEV NOTE (v1.6a patch2)
Selection prompts now display the prompt before listing options and echo the
chosen value so users can easily confirm their selection.
# DEV NOTE (v1.5f)
