...
All expressions inside these YAML files must be written in LaTeX math form; raw Python code is not permitted.
...
`copernican_lib/model_parser.py` validates the YAML and writes a sanitized copy to
