...
# DEV NOTE (v1.6a update): Reworked parser system with explicit registration and
# absolute dynamic imports. Added helper to list available data types.
...
def list_available_data_types():
    """Return sorted list of data types registered."""
    return sorted({dt for dt, _ in registry.keys()})
