...
| `docstring-and-comment-coverage` | Warns when any non-test Python module lacks docstrings or nearby explanatory comments. | Law 6 (Document every module, function and class with clear "what" and "why" explanations). | `AGENTS.md#policy-docstring-and-comment-coverage` | Both short docstrings and descriptive pre-definition comments satisfy the check; vendor/test code is ignored. |
