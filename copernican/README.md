...
![Copernican Suite banner](https://raw.githubusercontent.com/apostolovbg/copernican/main/docs/banner_github.png)
...
macOS, Linux and Windows. Developers must consult [AGENTS.md](https://github.com/apostolovbg/copernican/blob/main/AGENTS.md) and
