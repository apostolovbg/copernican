...
NumPy functions suitable for evaluation within the samplers. Spawn-based
...
class _GeneratedCallable:
    ...
    The samplers expect regular callables, yet plain functions generated by
    ...
    def python_function(self):
        ...
        Samplers should treat the wrapper as the canonical callable, yet tests
