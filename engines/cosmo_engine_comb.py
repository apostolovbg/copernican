...
:mod:`copernican_lib.model_coder`.  The engine itself only orchestrates the
optimisation and calculation of chi-squared values.
"""
# Compared to ``cosmo_engine_1_4b`` this module optimises against all datasets
# in one go so that parameter correlations are treated consistently.
