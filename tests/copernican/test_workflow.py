"""Smoke and CLI utility tests for the `copernican` workflow entrypoint."""
...
class TestEntrypoint(unittest.TestCase):
    """Exercise the package entrypoint without importing it as a module."""

    def test_entrypoint_exits_cleanly(self) -> None:
        with self.assertRaises(SystemExit) as caught:
            runpy.run_module("copernican.__main__", run_name="__main__")
