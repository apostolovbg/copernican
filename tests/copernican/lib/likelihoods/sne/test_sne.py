"""Smoke tests for copernican.lib.likelihoods.sne."""
...
from copernican.lib.likelihoods import sne as module
...
class TestImportModule(unittest.TestCase):
    ...
    def test_import_module(self) -> None:
        self.assertEqual(module.__name__, "copernican.lib.likelihoods.sne")
