"""Smoke tests for copernican.lib.engine_adapter."""

from __future__ import annotations

import unittest

from copernican.lib import camb_contract, engine_adapter, model_coder
...
class TestEngineAdapterExports(unittest.TestCase):
    ...
    def test_public_exports_are_present(self) -> None:
        ...
        self.assertTrue(
            hasattr(engine_adapter.EnginePlugin, "get_cmb_perturbation_data")
        )
