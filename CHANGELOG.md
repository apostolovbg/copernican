...
## Version 4.3.13
- 2025-09-02: Rewrote Arviz dependency line so installs work across CI platforms (OpenAI ChatGPT)

## Version 4.3.12
- 2025-09-02: Added pip-tools to pinned dependencies so pre-commit's lock hook runs in CI (OpenAI ChatGPT)
