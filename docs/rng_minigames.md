# RNG Mini-games
The mini-game documentation lives under
`copernican/rng_minigames/README.md` so the entire RNG toolkit can be dropped
into other repositories. Please consult that file for gameplay descriptions,
the launcher API, and contribution guidelines.
## Table of Contents
...
- `copernican/rng_minigames/alien_invasion/_storage/game_settings.yml` –
 ...
 every run. Global explosion parameters govern both player and enemy
