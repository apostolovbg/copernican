...
[`licenses/Union3-MIT.txt`](../licenses/Union3-MIT.txt) so the complete notice travels
with the repository even if the dataset is redistributed separately. When using
Union3 in publications cite Rubin et al. (2025) alongside the Copernican Suite
