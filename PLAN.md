# DEV NOTE (v1.5i hotfix 11): Pantheon+ dataset option documented and run control bug patched.
# DEV NOTE (v1.5i)
...
- 2025-06-22 – Hotfix 11: Pantheon+ dataset option added and run control bug resolved.
